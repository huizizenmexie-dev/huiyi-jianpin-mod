...
export const products: Product[] = [
  {
    ...
    applications: [
      { industry: "Chocolate & Confectionery", painPoint: "High refining viscosity, difficult molding, cocoa butter overuse", product: "HXY-1SP / HXY-3SP", dosage: "0.3–0.5% of total fat", effect: "Reduces viscosity 15-25%, improves flow and molding" },
      { industry: "Dairy & Instant Beverages", painPoint: "Fat floating, clumping, slow dissolution", product: "HXY-1SPN", dosage: "0.5–2% spray or dry blend", effect: "Uniform dispersion, wetting time reduced by 50%" },
  ...
  },
  {
    ...
    applications: [
      ...
      { industry: "Pharma Excipients", painPoint: "Poor aqueous dispersibility of APIs", product: "HXY-PLF", dosage: "As needed", effect: "Improves oral bioavailability" },
  ...
  },
  {
    ...
    applications: [
      { industry: "Functional Foods & Supplements", painPoint: "Need for choline, lipid metabolism support", product: "PC 50%", dosage: "As formulated", effect: "Supports healthy lipid metabolism and liver function" },
      { industry: "Pharma Excipients (Liposomes)", painPoint: "High-purity lipid for liposomal drug encapsulation", product: "PC 70%-90%", dosage: "As formulated", effect: "Effective drug carrier, improves bioavailability" },
      { industry: "Cosmetics", painPoint: "Skin dryness, need for antioxidants", product: "PC 30%", dosage: "0.5%-2.0% in emulsions", effect: "Moisturizer and antioxidant" },
    ],
  ...
  },
  {
    ...
    subtitle: "Purity 20%–70% | ISO 22000 | Cognitive Health",
    ...
    listingSpecs: "Cognitive Health | Enzymatic Synthesis",
    specifications: [
    ...
    applications: [
      { industry: "Brain Health Softgels", painPoint: "Cognitive support, memory improvement", product: "PS 50%", dosage: "100-300mg per serving", effect: "Supports cognitive function and memory" },
      { industry: "Dietary Supplements", painPoint: "Daily health maintenance", product: "PS 20%", dosage: "As formulated", effect: "General wellness" },
      { industry: "Pharma Formulations", painPoint: "Poor drug solubility", product: "PS 70%", dosage: "As formulated", effect: "Improves solubility and oral bioavailability" },
    ],
  ...
  },
  {
    ...
    applications: [
      { industry: "Infant Formula & Baby Food", painPoint: "Soy allergen concerns", product: "HXY-SFL", dosage: "As formulated", effect: "Safe emulsification without soy allergen risks" },
  ...
  },
  {
    ...
    applications: [
      ...
      { industry: "Weight Management Foods", painPoint: "High-fiber, low-calorie needs", product: "J18000", dosage: "As formulated", effect: "High swelling capacity provides satiety" },
    ],
  ...
  },
  {
    ...
    applications: [
      { industry: "Retail Health Supplements", painPoint: "Consumer-ready prebiotic or protein formats", product: "Sachets, capsules, small cans", dosage: "As packaged", effect: "Promotes gut health and muscle maintenance" },
      ...
      { industry: "Functional Beverages", painPoint: "Soluble fiber, low-calorie sweetener", product: "Soy Oligosaccharide", dosage: "As formulated", effect: "Prebiotic, mild sweetener" },
    ],
